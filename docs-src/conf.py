...
#
html_theme_options = {
    'nav_title': 'SQLAlchemy Unchained',
...
htmlhelp_basename = 'SQLAlchemyUnchaineddoc'
...
latex_documents = [
    (master_doc, 'SQLAlchemyUnchained.tex', 'SQLAlchemy Unchained Documentation',
...
man_pages = [
    (master_doc, 'sqlalchemyunchained', 'SQLAlchemy Unchained Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SQLAlchemyUnchained', 'SQLAlchemy Unchained Documentation',
     author, 'SQLAlchemyUnchained', 'One line description of project.',
     'Miscellaneous'),
]
